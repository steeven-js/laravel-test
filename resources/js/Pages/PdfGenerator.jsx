...
const PdfGenerator = () => {
  ...
  const styles = StyleSheet.create({
    ...
    cellService: { width: '46%', fontSize: 10 },
    cellQty: { width: '14%', fontSize: 10, textAlign: 'center', color: '#475569' },
    cellPrice: { width: '18%', fontSize: 10, textAlign: 'right' },
    cellTotal: { width: '22%', fontSize: 10, textAlign: 'right', fontWeight: 'bold' },
        ...
        <View style={styles.content}>
          ...
          <View style={styles.twoCols}>
            <View style={styles.col}>
              ...
              <View style={styles.infoRow}><Text style={styles.label}>Date</Text><Text style={styles.value}>{formatDate(document.date_devis || document.date_facture)}</Text></View>
              {document.date_validite && (<View style={styles.infoRow}><Text style={styles.label}>Validité</Text><Text style={styles.value}>{formatDate(document.date_validite)}</Text></View>)}
            </View>
            <View style={styles.col}>
              <Text style={styles.sectionTitle}>Statut</Text>
              <View style={styles.infoRow}><Text style={styles.label}>État</Text><Text style={styles.value}>{humanize(document.statut)}</Text></View>
              {document.taux_tva && (<View style={styles.infoRow}><Text style={styles.label}>TVA</Text><Text style={styles.value}>{document.taux_tva}%</Text></View>)}
            </View>
          </View>
